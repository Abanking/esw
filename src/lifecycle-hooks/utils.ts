...
import { EswAfterMount } from './esw-after-mount.interface';
...
export const isImplEswAfterMount = (instance: IEswInstance): instance is EswAfterMount => {
    return 'eswAfterMount' in instance;
};
